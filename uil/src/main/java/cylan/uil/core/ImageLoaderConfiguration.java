 ...
 *******************************************************************************/
package cylan.uil.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import cylan.uil.cache.disc.DiskCache;
import cylan.uil.cache.disc.naming.FileNameGenerator;
import cylan.uil.cache.memory.MemoryCache;
import cylan.uil.cache.memory.impl.FuzzyKeyMemoryCache;
import cylan.uil.core.assist.FlushedInputStream;
import cylan.uil.core.assist.ImageSize;
import cylan.uil.core.assist.QueueProcessingType;
import cylan.uil.core.decode.ImageDecoder;
import cylan.uil.core.download.ImageDownloader;
import cylan.uil.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link cylan.uil.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, cylan.uil.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link cylan.uil.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link cylan.uil.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link cylan.uil.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(cylan.uil.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link cylan.uil.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(cylan.uil.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link cylan.uil.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link cylan.uil.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link cylan.uil.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link cylan.uil.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link cylan.uil.utils.L#disableLogging()} to disable
	 ...
	 * using {@link cylan.uil.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
