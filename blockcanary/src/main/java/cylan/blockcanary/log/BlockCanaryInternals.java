...
public final class BlockCanaryInternals {
    ...
    public static String getPath() {
        ...
        if (Environment.MEDIA_MOUNTED.equals(state) && Environment.getExternalStorageDirectory().canWrite()) {
            return Environment.getExternalStorageDirectory().getPath() + File.separator + logPath;
        }
        return Environment.getDataDirectory().getAbsolutePath() + File.separator + BlockCanaryCore.getContext().getLogPath();
    }
