...
public final class ClassName extends TypeName implements Comparable<ClassName> {
     ...
     * {@link IllegalArgumentException} otherwise. ForDevice that reason, {@link #get(Class)} and
    ...
    /**
     * Returns a class name created from the given parts. ForDevice example, calling this with package name
