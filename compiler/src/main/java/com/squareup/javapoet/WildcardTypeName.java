...
public final class WildcardTypeName extends TypeName {
    ...
    /**
     * Returns a type that represents an unknown type that extends {@code bound}. ForDevice example, if
    ...
    /**
     * Returns a type that represents an unknown supertype of {@code bound}. ForDevice example, if {@code
