 ...
 *******************************************************************************/
package support.uil.core;

import android.content.Context;
import android.content.res.Resources;
import android.util.DisplayMetrics;
import support.uil.cache.disc.DiskCache;
import support.uil.cache.disc.naming.FileNameGenerator;
import support.uil.cache.memory.MemoryCache;
import support.uil.cache.memory.impl.FuzzyKeyMemoryCache;
import support.uil.core.assist.FlushedInputStream;
import support.uil.core.assist.ImageSize;
import support.uil.core.assist.QueueProcessingType;
import support.uil.core.decode.ImageDecoder;
import support.uil.core.download.ImageDownloader;
import support.uil.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link support.uil.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, support.uil.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link support.uil.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link support.uil.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link support.uil.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(support.uil.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link support.uil.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(support.uil.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link support.uil.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link support.uil.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link support.uil.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link support.uil.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link support.uil.utils.L#disableLogging()} to disable
	 ...
	 * using {@link support.uil.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
