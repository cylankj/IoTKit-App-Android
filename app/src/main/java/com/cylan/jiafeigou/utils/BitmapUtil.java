...
public class BitmapUtil {
    ...
    public static void addBitmapToLruCache(String path, ImageView view, ImageSize is, Bitmap bitmap) {
        String imageUrl = ImageDownloader.Scheme.FILE.wrap(path);
        ImageSize targetSize = ImageSizeUtils.defineTargetSizeForView(new ImageViewAware(view), is);
