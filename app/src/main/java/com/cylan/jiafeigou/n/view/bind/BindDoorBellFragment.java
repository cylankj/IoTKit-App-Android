...
//        }
//        Log.d("simple", "what the hell");
//        bundle.putInt(KEY_SUB_FRAGMENT_ID, R.msgId.fLayout_bind_device_list_fragment_container);
//        bundle.putParcelableArrayList(KEY_DEVICE_LIST, (ArrayList<? extends Parcelable>) resultList);
//        getActivity().getSupportFragmentManager()
//                .beginTransaction()
//                .setCustomAnimations(R.anim.slide_in_right, R.anim.slide_out_right
//                        , R.anim.slide_in_left, R.anim.slide_out_right)
//                .add(android.R.msgId.content, listFragmentWeakReference.get(), "BindDeviceListFragment")
