...
public interface CloudCorrelationDoorBellContract {
    ...
    interface View extends BaseView<Presenter> {
        void initRelativeRecycleView(List<BellBean> list);

        void initUnRelativeRecycleView(List<BellBean> list);
        ...
        void notifyUnRelativeRecycle(SuperViewHolder holder, int viewType, int layoutPosition, BellBean item, int flag);

        void notifyRelativeRecycle(SuperViewHolder holder, int viewType, int layoutPosition, BellBean item, int flag);
