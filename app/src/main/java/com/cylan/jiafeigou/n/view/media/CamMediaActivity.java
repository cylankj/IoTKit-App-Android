...
public class CamMediaActivity extends BaseFullScreenFragmentActivity<CamMediaContract.Presenter> implements
        ...
        vpContainer.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                if (basePresenter != null)
                    basePresenter.checkCollection(alarmMsg.dpMsgVersion, currentIndex);
            }
        });
        decideWhichView();
    ...
    private void updateFocus(boolean auto, int index) {
        ...
        if (basePresenter != null)
            basePresenter.checkCollection(alarmMsg.dpMsgVersion, index);
    }
        ...
        switch (view.getId()) {
            ...
            case R.id.imgV_big_pic_collect:
                ...
                if (tag == null || !(boolean) tag) {
                    if (basePresenter != null)
                        basePresenter.collect(currentIndex, alarmMsg.dpMsgVersion);
                } else {
                    if (basePresenter != null)
                        basePresenter.unCollect(currentIndex, alarmMsg.dpMsgVersion);
                }
