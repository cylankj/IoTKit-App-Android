...
import com.cylan.jiafeigou.utils.Pan720GlideURL;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        customToolbar.setViewFactory(new CustomToolbar.SimpleFactory() {
            ...
            public View createView() {
                View view = LayoutInflater.from(getContext()).inflate(R.layout.toolbar_720_pan, null);
                return view;
            }
        ...
        customToolbar.setToolbarLeftTitle(TimeUtils.getTimeSpecial(bean.getTime() * 1000L));
        Glide.with(this)
                .load(new Pan720GlideURL(mUUID, bean.getDownloadFile().fileName))
                .asBitmap()
