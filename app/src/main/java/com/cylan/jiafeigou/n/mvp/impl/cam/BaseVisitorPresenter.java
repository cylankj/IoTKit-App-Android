...
//        }
    ...
    public Observable<DpMsgDefine.ResponseHeader> deleteFaceByRobot(String faceId, String personId) {
...
//                    }
    ...
    public void deleteFace(int type, String id, int delMsg) {
        Subscription subscribe = Observable.zip(deleteFaceByDp(type, id, delMsg), deleteFaceByRobot(type == 1 ? id : null, type == 2 ? id : null),
