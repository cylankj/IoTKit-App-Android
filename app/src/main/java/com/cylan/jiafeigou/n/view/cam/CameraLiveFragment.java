...
//                ((CameraLiveActivity) getActivity()).addPutBundle(null);//使用完，清空
//            }
//        } else if (isResumed()) {
//            basePresenter.stopPlayVideo(basePresenter.getPlayType());
...
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.OFFLINE_ERR_1), getString(R.string.USER_HELP));
//                break;
//            case JFGRules.PlayErr.ERR_UNKOWN:
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.NO_NETWORK_2));
//                break;
//            case JFGRules.PlayErr.ERR_LOW_FRAME_RATE:
//                int net = NetUtils.getJfgNetType(getActivity());
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.GLOBAL_NO_NETWORK), net == 0 ? getString(R.string.USER_HELP) : null);
//                break;
//            case JFGRules.PlayErr.ERR_DEVICE_OFFLINE:
//            case JError.ErrorVideoPeerNotExist:
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.OFFLINE_ERR), getString(R.string.USER_HELP));
//                break;
//            case JError.ErrorVideoPeerInConnect:
//                //正在直播...
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.CONNECTING));
//                break;
//            case STOP_MAUNALLY:
//                camLiveController.setLoadingState(ILiveControl.STATE_STOP, null);
//                break;
//            case JFGRules.PlayErr.ERR_NOT_FLOW:
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.NETWORK_TIMEOUT));
//                break;
//            default:
//                camLiveController.setLoadingState(ILiveControl.PLAY_STATE_LOADING_FAILED, getString(R.string.GLOBAL_NO_NETWORK));
//                break;
//        }
//        if (liveListener != null) liveListener.liveStateChange();
//        vLive.onLiveStop();
