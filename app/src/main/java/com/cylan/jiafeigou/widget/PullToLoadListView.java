...
public class PullToLoadListView extends ListView implements OnScrollListener {
	...
	private OnLoadMoreListener mOnRefreshListener;
	...
	private void init(Context context) {
		...
		try {
			setOverScrollMode(AdapterView.OVER_SCROLL_ALWAYS);
	...
	public void setOnLoadMoreListener(OnLoadMoreListener onRefreshListener) {
