...
/**
 * Created by cylan-hunt on 16-7-11.
 */
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabBackgroundResId = R.drawable.background_tab_selector;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // if there is an offset, initSubscription interpolating left and right coordinates between current and next tab
        ...
        canvas.drawRect(lineLeft + 20,
                height - indicatorHeight,
                lineRight - 20, height, rectPaint);
