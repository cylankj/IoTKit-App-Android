...
public class StickyHeaderRecyclerView extends StickyHeader {

    private RecyclerView mRecyclerView;
    private int mScrolledY;
    private OnScrollListenerSticky mOnScrollerListenerSticky;

    StickyHeaderRecyclerView(final Context context, final RecyclerView recyclerView, final View header, final int minHeightHeader, final HeaderAnimator headerAnimator) {
    ...
    private void setupOnScrollListener() {
        if (mOnScrollerListenerSticky != null) {
            mRecyclerView.removeOnScrollListener(mOnScrollerListenerSticky);
        }

        mScrolledY = Integer.MIN_VALUE; // init scroll
        mOnScrollerListenerSticky = new OnScrollListenerSticky();
        mRecyclerView.addOnScrollListener(mOnScrollerListenerSticky);
    }
