...
public class WaveView extends View {
    ...
    public WaveView(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.WaveTheme, defStyle, 0);
        mFrontWaveColor = typedArray.getColor(R.styleable.WaveTheme_frontColor, Color.WHITE);
        mBehindWaveColor = typedArray.getColor(R.styleable.WaveTheme_behindColor, Color.WHITE);
        typedArray.recycle();
        init();
    }
