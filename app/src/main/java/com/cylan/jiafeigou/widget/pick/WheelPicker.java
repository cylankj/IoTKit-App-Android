package com.cylan.jiafeigou.widget.pick;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    private int mSelectedItemTextSize = -1;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mSelectedItemTextSize = (int) a.getDimension(R.styleable.WheelPicker_wheel_selected_item_text_size, mItemTextSize);
        a.recycle();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawnDataPos = drawnDataStartPos + mSelectedItemPosition,
            ...
            if (mSelectedItemTextColor != -1 || mSelectedItemTextSize != -1) {
                canvas.save();
                if (isCurved) {
