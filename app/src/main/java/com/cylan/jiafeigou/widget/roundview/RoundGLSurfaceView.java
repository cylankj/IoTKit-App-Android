...
public class RoundGLSurfaceView extends GLSurfaceView {
    ...
    private float mLT_Radius = 20;
    private float mRT_Radius = 20;
    private float mLB_Radius = 0;
    private float mRB_Radius = 0;
    ...
    public RoundGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        com.cylan.jiafeigou.widget.roundview.EGLConfigChooser chooser = new com.cylan.jiafeigou.widget.roundview.EGLConfigChooser();
        setEGLConfigChooser(chooser);
        glRenderer = new GLRenderer();
        glRenderer.setUsesCoverageAa(chooser.usesCoverageAa());
        setRenderer(glRenderer);
        setRenderMode(RENDERMODE_WHEN_DIRTY);
        setCornerRadius(mLT_Radius, mRT_Radius, mLB_Radius, mRB_Radius);
    }
    ...
    public static class GLRenderer
        ...
        private static String TAG = RoundedTextureView.GLRenderer.class.getSimpleName();
        ...
        public GLRenderer() {
            this(new GLRoundedGeometry(), new RectF(-1, 1, 1, -1));
        }

        public GLRenderer(@NonNull GLRoundedGeometry roundedGeometry,
