...
/**
 * Created by yanzhendong on 2017/8/18.
 */

public class PanoramicView360RS_Ext extends Panoramic360ViewRS implements VideoViewFactory.IVideoView {

    private VideoViewFactory.InterActListener interActListener;

    public PanoramicView360RS_Ext(Context context) {
        super(context);
    }
    ...
    public void setMode(int mode) {//0:俯视,1:平视
        super.setMountMode(mode == 0 ? Panoramic360ViewRS.MountMode.TOP : Panoramic360ViewRS.MountMode.WALL);
    }
