package com.cylan.jiafeigou.widget.slidingmenu.app;
...
public class SlidingActivityHelper {
	...
	public void onCreate(Bundle savedInstanceState) {
		mSlidingMenu = (SlidingMenu) LayoutInflater.from(mActivity).inflate(com.cylan.jiafeigou.R.layout.slidingmenumain, null);
	}
