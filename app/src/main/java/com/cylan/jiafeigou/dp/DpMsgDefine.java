...
//        @Index(0)
//        @JsonProperty(value = "standby", index = 0)
//        public boolean standby;
//        @Index(1)
//        @JsonProperty(value = "alarmEnable", index = 1)
//        public boolean alarmEnable;
//        @Index(2)
//        @JsonProperty(value = "led", index = 2)
//        public boolean led;
//        @Index(3)
//        @JsonProperty(value = "autoRecord", index = 3)
//        public Integer autoRecord;
//
