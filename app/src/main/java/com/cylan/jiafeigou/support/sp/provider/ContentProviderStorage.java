...
package com.cylan.jiafeigou.support.sp.provider;
...
import com.cylan.jiafeigou.support.sp.TrayPreferences;
import com.cylan.jiafeigou.support.sp.core.OnTrayPreferenceChangeListener;
import com.cylan.jiafeigou.support.sp.core.TrayException;
import com.cylan.jiafeigou.support.sp.core.TrayItem;
import com.cylan.jiafeigou.support.sp.core.TrayLog;
import com.cylan.jiafeigou.support.sp.core.TrayRuntimeException;
import com.cylan.jiafeigou.support.sp.core.TrayStorage;
...
public class ContentProviderStorage extends TrayStorage {
    ...
    public ContentProviderStorage(@NonNull final Context context, @NonNull final String module,
                                  @NonNull final TrayStorage.Type type) {
        super(module, type);
