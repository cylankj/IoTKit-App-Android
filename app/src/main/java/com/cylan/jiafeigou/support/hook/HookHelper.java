...
public class HookHelper {
    ...
    public static void hookAMS() {
        try {
            Class<?> AMS_NativeClass = Class.forName("android.app.ActivityManagerNative");
            // 获取 gDefault 这个字段, 想办法替换它
            Field gDefaultField = AMS_NativeClass.getDeclaredField("gDefault");
