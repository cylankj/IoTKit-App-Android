...
public interface ShareConstant {
    ...
    int SHARE_CONTENT_H5_WITH_UPLOAD = 1;
    int SHARE_CONTENT_WEB_URL = 2;


    String SHARE_PLATFORM_TYPE = "share_platform_type";
    int SHARE_PLATFORM_TYPE_TIME_LINE = 0;
    int SHARE_PLATFORM_TYPE_WECHAT = 1;
    int SHARE_PLATFORM_TYPE_QQ = 2;
    int SHARE_PLATFORM_TYPE_QZONE = 3;
