package com.cylan.jiafeigou.support.download.database;

import android.content.Context;
import android.database.sqlite.SQLiteDatabase;
import android.database.sqlite.SQLiteOpenHelper;

import com.cylan.jiafeigou.support.download.database.constants.CHUNKS;
import com.cylan.jiafeigou.support.download.database.constants.TABLES;
import com.cylan.jiafeigou.support.download.database.constants.TASKS;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private final static String DATABASE_NAME = "download_center";
    private final static int DATABASE_VERSION = 5;

    private final static String CREATE_TABLE_TASKS =
