...
//        UploadMonitorLog.forceZipLogAndUpload();
    ...
    /**
     * Record monitor initSubscription startTime to preference, you may use it when after push which tells initSubscription BlockCanary.
     */
...
//            Constructor<? extends OnBlockEventInterceptor> constructor = notifier.getConstructor();
            mBlockCanaryCore.setOnBlockEventInterceptor(new CustomBlockEvent());
        } catch (Exception e) {
