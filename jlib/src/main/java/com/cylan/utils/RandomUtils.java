...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.cylan.common.utils.RandomUtils#getRandom(String source, int length)
     */
     ...
     * <li>else see {@link com.cylan.common.utils.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     * </ul>
     */
